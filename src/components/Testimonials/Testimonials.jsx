...
const Testimonials = () => {
  return (
    <div className='flex flex-col items-center'>
        ...
        <p className='text-center text-washed-purple-400 text-lg leading-7 md:mx-24 xxxsm:w-[80%]'>Maximize your potential with personalized interview tracking. Elevate your skills, stand out, and secure your dream job effortlessly.</p>
