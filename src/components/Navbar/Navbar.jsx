...
const Navbar = () => {
  return (
    <div className='bg-neutrals flex justify-between items-center bg-black-2 p-6 pt-10 md:'>
      <h1 id='accueil' className='text-2xl text-white md:text-xl'>Reviewent</h1>
      <div>
        <ul className='text-white md:text-sm'>
          <li className='font-light flex gap-10 border-[1px] border-neutrals-11 p-2 px-10 ml-16 rounded-xl md:ml-0 md:px-6'>
      ...
      <div>
        <ul className='text-white md:text-md'>
